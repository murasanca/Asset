...
namespace murasanca
{
    public class Screenshot:EditorWindow
    {
        ...
        private void Awake()=>m=new GUIContent("Screenshot by Murat Sancak",LoadAssetAtPath<Texture2D>("Assets/Murat Sancak/Screenshot/Sprite/Murat Sancak.png"));
        ...
        private void OnGUI()
        {
            ...
            )
            {
                ...
                switch(pu=Popup(new Rect(8,80,position.width-16,16),pu,o,popup))
                {
                    ...
                    case 2:
                        // Path Text Field.
                        p=p is ""
                            ?TextArea(new Rect(8,104,position.width-16,32),Concat(Application.dataPath,"/Murat Sancak/Screenshot"),textArea)
                ...
                if(pu is 2)
                {
                    ...
                    // Eye Label Field.
                    LabelField(new Rect(8,240,position.width-16,16),"Eye",centeredGreyMiniLabel);
                    // Left Toggle.
                ...
                else // popup is 0 or 1.
                {
                    ...
                    // Eye Label Field.
                    LabelField(new Rect(8,200,position.width-16,16),"Eye",centeredGreyMiniLabel);
                    // Left Toggle.
            ...
            // Drop Shadow Label.
            DropShadowLabel(new Rect(position.width/2-32,position.height-72,64,64),m,centeredGreyMiniLabel);
        }

        private void OnInspectorUpdate()
        {
            m=new GUIContent(LoadAssetAtPath<Texture2D>("Assets/Murat Sancak/Screenshot/Sprite/Murat Sancak.png"));
